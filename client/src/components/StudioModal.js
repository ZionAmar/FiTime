...
function StudioModal({ studio, onClose, onSave }) {
    ...
    useEffect(() => {
        ...
        document.addEventListener('click', stopPropagationListener, true);
        document.addEventListener('focus', stopPropagationListener, true); // תופס גם אירועי פוקוס
        
        return () => {
            document.removeEventListener('click', stopPropagationListener, true);
            document.removeEventListener('focus', stopPropagationListener, true);
        };
    }, []);
            ...
            <div className="modal-overlay" onClick={onClose}>
                <div className="modal-content" style={{maxWidth: '600px'}} onClick={e => e.stopPropagation()}>
                    ...
                    <form onSubmit={handleSubmit} className="settings-form">
                        <fieldset disabled={isLoading} className="form-section-group">
