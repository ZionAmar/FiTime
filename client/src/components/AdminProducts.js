...
import '../styles/CardGridView.css'; // כמו ב-TrainersView
...
function AdminProducts() {
    ...
    return (
        <div className="card-grid-container">
            {/* כותרת עליונה כמו ב-TrainersView */}
                ...
                >
                    ...
                    <div className="form-field">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            placeholder="השאר ריק למנוי ללא הגבלה"
                            min="1"
                        />
                    </div>
                    ...
                    <div className="form-field">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            placeholder="השאר ריק למנוי ללא הגבלת זמן"
                            min="1"
                        />
                    </div>
                            ...
                            >
                                <p>
                                    {searchTerm
                                        ...
                                        : 'עדיין לא יצרת מנויים או כרטיסיות.'}
                                </p>
                                {!searchTerm && (
                                    <button
                                        className="btn btn-primary"
            ...
            <ConfirmModal
                ...
                cancelText="ביטול"
                confirmButtonType={
                    confirmState.confirmButtonType || 'btn-primary'
                }
            />
